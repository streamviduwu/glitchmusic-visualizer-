                ...
                return u(t, [{
                    ...
                    value: function() {
                        var e = a(o.mark((function e(r, n, a, i) {
                            var u, l, f, p, y, w, b, O, j, I, T, A, D, M, N, U, W, q, F, G, B, H, V, z, X, J, $, Y, Q;
                            return o.wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 3:
                                        ...
                                        break;
                                    case 15:
                                        if (i._h || (this.isSsr = !1), h.ST && performance.mark("routeChange"), this._inFlightRoute && this.abortComponentLoad(this._inFlightRoute), a = P(_(S(a) ? k(a) : a, i.locale, this.defaultLocale)), l = x(S(a) ? k(a) : a, this.locale), this._inFlightRoute = a, i._h || !this.onlyAHashChange(l)) {
                                            e.next = 29;
                                            break
                                        }
                                    ...
                                    case 45:
                                        ...
                                        if (D = (0, v.parseRelativeUrl)(A), M = D.pathname, N = (0, g.getRouteRegex)(j), U = (0, m.getRouteMatcher)(N)(M), q = (W = j === M) ? R(j, M, w) : {}, U && (!W || q.result)) {
                                            e.next = 68;
                                            break
                                        }
                                        ...
                                        throw new Error((W ? "The provided `href` (".concat(n, ") value is missing query values (").concat(F.join(", "), ") to be interpolated properly. ") : "The provided `as` value (".concat(M, ") is incompatible with the `href` value (").concat(j, "). ")) + "Read more: https://err.sh/vercel/next.js/".concat(W ? "href-interpolation-failed" : "incompatible-href-as"));
                                    case 66:
                                        e.next = 69;
                                        break;
                                    case 68:
                                        W ? a = (0, h.formatWithValidation)(Object.assign({}, D, {
                                            pathname: q.result,
                                            query: L(w, q.params)
                                        })) : Object.assign(w, U);
                                    case 69:
                                    ...
                                    case 73:
                                        ...
                                        if (J = (0, v.parseRelativeUrl)(X), this._resolveHref(J, b, !1), !b.includes(J.pathname)) {
                                            e.next = 83;
                                            break
                                        }
                                    ...
                                    case 85:
                                        return t.events.emit("beforeHistoryChange", a), this.changeState(r, n, a, i), e.next = 90, this.set(j, y, w, l, G).catch((function(t) {
